...
/**
 * @type {import('primereact/timeline').TimelinePassThroughOptions}
 */
export const timeline = {
  ...
  marker:
    'flex self-baseline w-4 h-4 rounded-full border-2 border-primary bg-base-100',

  connector: ({ props }) => ({
    className: classNames('grow bg-base-300', {
